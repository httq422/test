...
void set_angle0(unsigned int duty)
{
...
void set_angle2(unsigned int duty)
{
    unsigned int time = 20000;
...
void set_angle10(unsigned int duty)
{
    unsigned int time = 20000;
...
*/
void engine0_turn_left_90(void)
{
    unsigned int angle = 550;
    for (int i = 0; i < COUNT; i++) {
        set_angle0(angle);
    }
}

void engine1_turn_left_90(void)
{
    unsigned int angle = 600;
    for (int i = 0; i < COUNT; i++) {
        set_angle1(angle);
    }
}

void engine2_turn_left_90(void)
{
    unsigned int angle = 600;
    for (int i = 0; i < COUNT; i++) {
        set_angle2(angle);
...
void engine10_turn_left_90(void)
{
    unsigned int angle = 550;
    for (int i = 0; i < COUNT; i++) {
        set_angle10(angle);
...
1、依据角度与脉冲的关系，设置高电平时间为2400微秒
2、不断地发送信号，控制舵机向右
*/
void engine0_turn_right_90(void)
{
...
void engine1_turn_right_90(void)
{
...
void engine2_turn_right_90(void)
{
    unsigned int angle = 2450;
    for (int i = 0; i < COUNT; i++) {
        set_angle2(angle);
...
void engine10_turn_right_90(void)
{
    unsigned int angle = 2400;
    for (int i = 0; i < COUNT; i++) {
        set_angle10(angle);
...
HisignallingErrorType HisignallingMsgReceive(hi_u8 *buf, hi_u32 len)
{
    ...
    if(number==3){
        if(test_bit==0&&count_bit==1){
    engine0_turn_left_90();
    printf("Turn 90 degrees to the left of the steering gear0\r\n");
        number=0;
        test_bit=0;
    }

       if(test_bit==0&&count_bit==2){
    engine1_turn_left_90();
    printf("Turn 90 degrees to the left of the steering gear0\r\n");
        number=0;
        test_bit=0;
    }

if(test_bit==0&&count_bit==3){
    engine2_turn_left_90();
    printf("Turn 90 degrees to the left of the steering gear0\r\n");
        number=0;
        test_bit=0;
    }

    if(test_bit==0&&count_bit==4){
    engine10_turn_left_90();
    printf("Turn 90 degrees to the left of the steering gear0\r\n");
        number=0;
        test_bit=0;
    }

    if(test_bit==0&&count_bit==5){
    engine0_turn_right_90();
    printf("Turn 90 degrees to the right of the steering gear0\r\n");
        number=0;
        test_bit=0;
    }

    if(test_bit==0&&count_bit==6){
    engine1_turn_right_90();
    printf("Turn 90 degrees to the right of the steering gear0\r\n");
        number=0;
        test_bit=0;
    }

    if(test_bit==0&&count_bit==7){
    engine2_turn_right_90();
    printf("Turn 90 degrees to the right of the steering gear0\r\n");
        number=0;
        test_bit=0;
    }

    if(test_bit==0&&count_bit==8){
    engine10_turn_right_90();
    printf("Turn 90 degrees to the right of the steering gear0\r\n");
        number=0;
        test_bit=0;
    }
